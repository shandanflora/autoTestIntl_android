...
public class WorkLogActivity {
    ...
    @FindBy(id = "com.ecovacs.ecosphere.intl:id/tv_counttiem")
    private AndroidElement timeTotal = null;
    @FindBy(id = "com.ecovacs.ecosphere.intl:id/tvTimeTips")
    private AndroidElement timeTips = null;
    @FindBy(id = "com.ecovacs.ecosphere.intl:id/tips")
    private AndroidElement cleanHistory = null;
